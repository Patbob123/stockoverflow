...
public class Portfolio {
    ...
    private final Map<String, Comparator<String>> portfolioSortMap = new HashMap<>(Map.of(
            "by name", (ticker1, ticker2) -> stocks.get(ticker1).getName().compareTo(stocks.get(ticker2).getName()),
    ...
    public void sortPortfolio(){
        this.visualStocks.sort(this.portfolioSortMap.get(PORTFOLIO_SORT[0]));
    }
